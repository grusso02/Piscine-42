...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/12 11:45:05 by grusso            #+#    #+#             */
/*   Updated: 2020/11/12 11:45:07 by grusso           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_check_nb_lines(char **map, int height)
{
	char	*nblines;
	int		nblinesint;
	int		i;
...
int		ft_check_line_length_consistency(char **map)
{
	int ref_len;
	int i;
...
int		ft_check_charset_consistency(char **map)
{
	char	*charptr;
	int		j;
	int		i;
...
char	**ft_check_map(char **map, int height)
{
	if (!(ft_check_first_2_lines(map)))
		return (NULL);
	if (!(ft_check_nb_lines(map, height)))
		return (NULL);
	if (!(ft_check_line_length_consistency(map)))
		return (NULL);
	if (!(ft_check_charset_consistency(map)))
		return (NULL);
	return (map);
}
